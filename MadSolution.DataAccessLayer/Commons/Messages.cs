namespace MadSolution.DataAccessLayer.Commons
{
    ...
    {
        public static readonly string MaxItemsNumberIsLowerThanOne = "Max items number is lower than 1";
        public static readonly string MaxCountReached = "Max items number reached";
